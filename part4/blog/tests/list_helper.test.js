...
describe("total likes", () => {
	...
	test("when list has empty blog, must return 0", () => {
		const result = listHelper.totalLikes([]);
		assert.strictEqual(result, 0);
	});

	test("when list is has more blogs", () => {
...
describe("favorite one", () => {
	test("when list has more than one blogs", () => {
		const result = listHelper.favoriteOne(blogs);
		assert.deepStrictEqual(result, blogs[2]);
	});

	test("when list has only one blog", () => {
		const result = listHelper.favoriteOne([blogs[0]]);
		assert.deepStrictEqual(result, blogs[0]);
	});

	test("when list is empty", () => {
		const result = listHelper.favoriteOne([]);
